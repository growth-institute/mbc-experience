			...
			<div class="row row-md">
				...
				<div class="col col-4 col-md-4">
					<nav class="footer-menu">
						<h2>Contact Us</h2>
						<ul class="menu">
							<li class="menu-item">701 Brazos St,<br>16th Floor<br>Austin, TX 78701</li>
							<li class="menu-item"><i class="fa fa-fw fa-phone"></i> 1 800 975 5108</li>
							<li class="menu-item"><i class="fa fa-fw fa-envelope"></i> <a href="mailto:support@growthinstitute.com">support@growthinstitute.com</a></li>
						</ul>
					</nav>
				</div>
				<div class="col col-4 col-md-4">
					<div class="copyright">
						...
						<p>
							...
							<img src="<?php $site->img('template/eo-logo.png'); ?>" alt="EO: Entrepreneurs Organization">
						</p>
					</div>
				</div>
			</div>
